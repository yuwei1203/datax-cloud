...
<script>
import { pageDictItem, delDictItem, delDictItems } from '@/api/system/dict'
...
export default {
  ...
  data() {
    return {
      ...
      // 表格头
      tableColumns: [
        { prop: 'itemText', label: '字典项文本', show: true },
        { prop: 'itemValue', label: '字典项值', show: true },
        {
          prop: 'status',
          label: '状态',
          show: true,
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      pageDictItem(this.queryParams).then(response => {
        this.loading = false
        if (response.success) {
          const { data } = response
          this.dictItemList = data.data
    ...
    handleAdd() {
      ...
      this.showOptions.data.dictId = this.data.dictId
      this.showOptions.showList = false
      this.showOptions.showAdd = false
      this.showOptions.showEdit = false
      this.showOptions.showDetail = false
      this.showOptions.showItemList = false
      this.showOptions.showItemAdd = true
      this.showOptions.showItemEdit = false
      this.showOptions.showItemDetail = false
      this.$emit('showCard', this.showOptions)
    },
    /** 修改按钮操作 */
    handleEdit(row) {
      ...
      this.showOptions.showDetail = false
      this.showOptions.showItemList = false
      this.showOptions.showItemAdd = false
      this.showOptions.showItemEdit = true
      this.showOptions.showItemDetail = false
      this.$emit('showCard', this.showOptions)
    },
    /** 详情按钮操作 */
    handleDetail(row) {
      ...
      this.showOptions.showItemAdd = false
      this.showOptions.showItemEdit = false
      this.showOptions.showItemDetail = true
      this.$emit('showCard', this.showOptions)
    },
    /** 删除按钮操作 */
    handleDelete(row) {
