...
<script>
import { pageDict, delDict, delDicts, refreshDict } from '@/api/system/dict'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      pageDict(this.queryParams).then(response => {
        this.loading = false
        if (response.success) {
          const { data } = response
    ...
    handleItem(row) {
      ...
      this.showOptions.data.dictId = row.id
      this.showOptions.showList = false
      this.showOptions.showAdd = false
      this.showOptions.showEdit = false
      this.showOptions.showDetail = false
      this.showOptions.showItemList = true
