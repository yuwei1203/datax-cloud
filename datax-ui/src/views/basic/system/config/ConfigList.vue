...
<script>
import { pageConfig, delConfig, delConfigs, refreshConfig } from '@/api/system/config'
...
export default {
  ...
  data() {
    return {
      ...
      // 表格头
      tableColumns: [
        { prop: 'configName', label: '参数名称', show: true },
        { prop: 'configKey', label: '参数键名', show: true },
        { prop: 'configValue', label: '参数键值', show: true },
        {
          prop: 'status',
          label: '状态',
          show: true,
